...
| 40 | toast                               | go to secure checkout button on toast                                 | brings the user to the cart page                                                                   | PASS                      |
| 41 | cart                                | cart quantity plus and minus                                          | increases or decreases the number displayed under qty                                              | PASS                      |
| 42 | cart                                | cart update button                                                    | updates the subtotal and total price for the quantity of items selected                            | PASS                      |
| 43 | cart                                | cart remove button                                                    | removes a specific item from the cart                                                              | PASS                      |
| 44 | cart                                | cart keep shopping button                                             | sends the user to the all products page                                                            | PASS                      |
| 45 | cart                                | secure checkout button on cart page                                   | sends the user to the checkout template                                                            | PASS                      |
| 46 | checkout                            | checkout clickable image in the order summary                         | sends the user to the product detail page                                                          | PASS                      |
| 47 | checkout                            | toggle box for saving delivery information                            | saves delivery information on the profile so that it is prefilled in the form the next time        | PASS                      |
| 48 | checkout                            | checkout adjust cart button                                           | sends the users to the cart page                                                                   | PASS                      |
| 49 | checkout                            | checkout complete order button                                        | sends the user to the checkout success page                                                        | PASS                      |
| 50 | checkout success page               | checkout success page now check out the latest deals                  | sends the user to a filtered products page with sale items                                         | PASS                      |
| 51 | contact page                        | contact us jump link                                                  | brings the user to the contact form further down the page                                          | PASS                      |
| 52 | contact page                        | contact page mailto link                                              | opens your local email service                                                                     | PASS                      |
| 53 | contact page                        | contact form submit button                                            | submits the contact form if the fields pass validation                                             | PASS                      |
| 54 | wishlist page                       | clickable image                                                       | brings the user to the product detail page                                                         | PASS                      |
| 55 | wishlist page                       | clickable category                                                    | brings the user to a filtered products page                                                        | PASS                      |
| 56 | wishlist page                       | product details button                                                | brings the user to that specific product detail page                                               | PASS                      |
| 57 | wishlist page                       | return to shop button appears when there are no items in the wishlist | brings user to the all products page                                                               | PASS                      |
| 58 | profile                             | clickable order number                                                | brings the user to a past confirmation                                                             | PASS                      |
| 59 | profile                             | update information button                                             | updates the default delivery information and works as expected                                     | PASS                      |
| 60 | order history                       | back to profile button                                                | brings the user back to their personal profile with their order history                            | PASS                      |
| 61 | product management - add a product  | category dropdown                                                     | shows 9 drop down options correctly                                                                | PASS                      |
| 62 | product management - add a product  | has sizes dropdown                                                    | has the appropriate options in the dropdown                                                        | PASS                      |
| 63 | product management - add a product  | is course dropdown                                                    | has the appropriate options in the dropdown                                                        | PASS                      |
| 64 | product management - add a product  | select image button                                                   | opens files locally for selection                                                                  | PASS                      |
| 65 | product management - add a product  | cancel button                                                         | brings the user to the all products page                                                           | PASS                      |
| 66 | product management - add a product  | add product button                                                    | submits form                                                                                       | PASS                      |
| 67 | product management - edit a product | select image button                                                   | opens files locally for selection                                                                  | PASS                      |
| 68 | product management - edit a product | cancel button                                                         | brings the user to the all products page                                                           | PASS                      |
| 69 | product management - edit a product | remove button on the image                                            | when update product is clicked this removes the image                                              | PASS                      |
| 70 | product management - edit a product | update product button                                                 | submits the form and edits the information for that item                                           | PASS                      |
| 71 | login                               | forgot password                                                       | brings the user to a password reset page                                                           | PASS                      |
| 72 | login                               | home button                                                           | brings the user to the index page                                                                  | PASS                      |
| 73 | login                               | signin                                                                | submits the form and authenticates the user                                                        | PASS                      |
| 74 | register page                       | back to login button                                                  | brings the user to the login page                                                                  | PASS                      |
| 75 | register page                       | sign up button                                                        | submits the form if valid and send the user to a confirm email page                                | PASS                      |
| 76 | logout page                         | cancel button                                                         | sends the user to the index page                                                                   | PASS                      |
| 77 | logout page                         | sign out button                                                       | sends the user to the index page and shows success toast saying you have signed out                | PASS                      |
