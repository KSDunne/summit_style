...
| 56 | product management - add a product  | category dropdown                                           | shows 9 drop down options correctly                                                                | PASS                      |
| 57 | product management - add a product  | has sizes dropdown                                          | has the appropriate options in the dropdown                                                        | PASS                      |
| 58 | product management - add a product  | is course dropdown                                          | has the appropriate options in the dropdown                                                        | PASS                      |
| 59 | product management - add a product  | select image button                                         | opens files locally for selection                                                                  | PASS                      |
| 60 | product management - add a product  | cancel button                                               | brings the user to the all products page                                                           | PASS                      |
| 61 | product management - add a product  | add product button                                          | submits form                                                                                       | PASS                      |
| 62 | product management - edit a product | select image button                                         | opens files locally for selection                                                                  | PASS                      |
