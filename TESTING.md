...
| 57 | profile                             | clickable order number                                      | brings the user to a past confirmation                                                             | PASS                      |
| 58 | profile                             | update information button                                   | updates the default delivery information and works as expected                                     | PASS                      |
| 59 | order history                       | back to profile button                                      | brings the user back to their personal profile with their order history                            | PASS                      |
| 60 | product management - add a product  | category dropdown                                           | shows 9 drop down options correctly                                                                | PASS                      |
| 61 | product management - add a product  | has sizes dropdown                                          | has the appropriate options in the dropdown                                                        | PASS                      |
| 62 | product management - add a product  | is course dropdown                                          | has the appropriate options in the dropdown                                                        | PASS                      |
| 63 | product management - add a product  | select image button                                         | opens files locally for selection                                                                  | PASS                      |
| 64 | product management - add a product  | cancel button                                               | brings the user to the all products page                                                           | PASS                      |
| 65 | product management - add a product  | add product button                                          | submits form                                                                                       | PASS                      |
| 66 | product management - edit a product | select image button                                         | opens files locally for selection                                                                  | PASS                      |
| 67 | product management - edit a product | cancel button                                               | brings the user to the all products page                                                           | PASS                      |
| 68 | product management - edit a product | remove button on the image                                  | when update product is clicked this removes the image                                              | PASS                      |
| 69 | product management - edit a product | update product button                                       | submits the form and edits the information for that item                                           | PASS                      |
| 70 | login                               | forgot password                                             | brings the user to a password reset page                                                           | PASS                      |
| 71 | login                               | home button                                                 | brings the user to the index page                                                                  | PASS                      |
| 72 | login                               | signin                                                      | submits the form and authenticates the user                                                        | PASS                      |
| 73 | register page                       | back to login button                                        | brings the user to the login page                                                                  | PASS                      |
| 74 | register page                       | sign up button                                              | submits the form if valid and send the user to a confirm email page                                | PASS                      |
| 75 | logout page                         | cancel button                                               | sends the user to the index page                                                                   | PASS                      |
| 76 | logout page                         | sign out button                                             | sends the user to the index page and shows success toast saying you have signed out                | PASS                      |
