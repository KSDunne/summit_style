...
| 3  | navbar                       | navbar all products                                         | shows a dropdown with filtering options and a sale button                                          | PASS                      |
| 4  | navbar                       | navbar clothes                                              | shows a dropdown with multiple clothes categories                                                  | PASS                      |
| 5  | navbar                       | navbar equipment                                            | shows a dropdown with multiple equipment categories                                                | PASS                      |
| 6  | navbar                       | navbar courses                                              | shows a dropdown with multiple course categories                                                   | PASS                      |
| 7  | navbar                       | navbar contact                                              | brings the user to the contact page where a form is rendered                                       | PASS                      |
