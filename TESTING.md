...
| custom error page | <details><summary>Error Page</summary><img src="./docs/readme_images/validation/error_html.png"></details>              | PASS                                              |
...
| 11 | navbar                              | hover effect on navbar links and dropdowns                            | turns from black to blue                                                                           | PASS                      |
| 12 | index page                          | shop now button                                                       | brings the user to the all products page                                                           | PASS                      |
| 13 | index page                          | recycled packaging (external link)                                    | link opens in a new tab                                                                            | PASS                      |
| 14 | index page                          | reforest nation (external link)                                       | link opens in a new tab                                                                            | PASS                      |
| 15 | index page                          | technical skills and safety (internal link)                           | sends the user to the products page that is filtered to just courses                               | PASS                      |
| 16 | index page                          | leave no trace (external link)                                        | link opens in a new tab                                                                            | PASS                      |
| 17 | mailchimp section                   | subscribe button                                                      | if the user entered their email address this button will submit the address to mailchimp           | PASS                      |
| 18 | footer                              | clickable facebook icon                                               | a new tab opens with the summit style facebook page                                                | PASS                      |
| 19 | footer                              | clickable instagram icon                                              | link opens in a new tab                                                                            | PASS                      |
| 20 | footer                              | clickable github icon                                                 | link opens in a new tab                                                                            | PASS                      |
| 21 | footer                              | hover effect on social icons in footer                                | turn from black to pink                                                                            | PASS                      |
| 22 | footer                              | mail to link                                                          | opens up your local email service                                                                  | PASS                      |
| 23 | footer                              | privacy policy button                                                 | opens the privacy policy for the user                                                              | PASS                      |
| 24 | products page                       | clickable images on all product page                                  | brings the user to product detail page                                                             | PASS                      |
| 25 | products page                       | sort by                                                               | when clicked this opens a dropdown menu with filter options                                        | PASS                      |
| 26 | products page                       | the category shown on product carts                                   | this is clickable and will bring the user to a filtered product page                               | PASS                      |
| 27 | products page                       | products home button displays when products are filtered              | brings the user back to all products page                                                          | PASS                      |
| 28 | products page                       | edit button on all products (shown to superusers)                     | brings a store owner to 'edit product' page                                                        | PASS                      |
| 29 | products page                       | delete button on all products (shown to superusers)                   | brings a store owner to a defensive 'are you sure?' page                                           | PASS                      |
| 30 | product detail                      | product detail clickable heart                                        | add or remove the product to a wishlist the heart will toggle from outline to solid and back again | PASS                      |
| 31 | product detail                      | product detail edit and delete buttons (shown to superuser)           | sends user to the appropriate page for the action                                                  | PASS                      |
| 32 | product detail                      | product detail size                                                   | displays dropdown options                                                                          | PASS                      |
| 33 | product detail                      | product detail keep shopping button                                   | sends user to all products page                                                                    | PASS                      |
| 34 | product detail                      | add to cart button                                                    | adds item to cart and displays toast if successful                                                 | PASS                      |
| 35 | product detail                      | submit button on write a review                                       | submits the review form                                                                            | PASS                      |
| 36 | product detail                      | edit button on my review                                              | brings the user to an edit page                                                                    | PASS                      |
| 37 | product detail                      | delete button on my review                                            | brings the user to a defensive 'are you sure?' page                                                | PASS                      |
| 38 | review edit page                    | edit review button                                                    | submits form and updates the review                                                                | PASS                      |
| 39 | delete review page                  | confirm button                                                        | deletes that review instance                                                                       | PASS                      |
| 40 | delete product page                 | cancel button                                                         | sends the user to the all products page                                                            | PASS                      |
| 41 | delete product page                 | confirm button                                                        | deletes that product instance                                                                      | PASS                      |
| 42 | toast                               | go to secure checkout button on toast                                 | brings the user to the cart page                                                                   | PASS                      |
| 43 | cart                                | cart quantity plus and minus                                          | increases or decreases the number displayed under qty                                              | PASS                      |
| 44 | cart                                | cart update button                                                    | updates the subtotal and total price for the quantity of items selected                            | PASS                      |
| 45 | cart                                | cart remove button                                                    | removes a specific item from the cart                                                              | PASS                      |
| 46 | cart                                | cart keep shopping button                                             | sends the user to the all products page                                                            | PASS                      |
| 47 | cart                                | secure checkout button on cart page                                   | sends the user to the checkout template                                                            | PASS                      |
| 48 | checkout                            | checkout clickable image in the order summary                         | sends the user to the product detail page                                                          | PASS                      |
| 49 | checkout                            | toggle box for saving delivery information                            | saves delivery information on the profile so that it is prefilled in the form the next time        | PASS                      |
| 50 | checkout                            | checkout adjust cart button                                           | sends the users to the cart page                                                                   | PASS                      |
| 51 | checkout                            | checkout complete order button                                        | sends the user to the checkout success page                                                        | PASS                      |
| 52 | checkout success page               | checkout success page now check out the latest deals                  | sends the user to a filtered products page with sale items                                         | PASS                      |
| 53 | contact page                        | contact us jump link                                                  | brings the user to the contact form further down the page                                          | PASS                      |
| 54 | contact page                        | contact page mailto link                                              | opens your local email service                                                                     | PASS                      |
| 55 | contact page                        | contact form submit button                                            | submits the contact form if the fields pass validation                                             | PASS                      |
| 56 | wishlist page                       | clickable image                                                       | brings the user to the product detail page                                                         | PASS                      |
| 57 | wishlist page                       | clickable category                                                    | brings the user to a filtered products page                                                        | PASS                      |
| 58 | wishlist page                       | product details button                                                | brings the user to that specific product detail page                                               | PASS                      |
| 59 | wishlist page                       | return to shop button appears when there are no items in the wishlist | brings user to the all products page                                                               | PASS                      |
| 60 | profile                             | clickable order number                                                | brings the user to a past confirmation                                                             | PASS                      |
| 61 | profile                             | update information button                                             | updates the default delivery information and works as expected                                     | PASS                      |
| 62 | order history                       | back to profile button                                                | brings the user back to their personal profile with their order history                            | PASS                      |
| 63 | product management - add a product  | category dropdown                                                     | shows 9 drop down options correctly                                                                | PASS                      |
| 64 | product management - add a product  | has sizes dropdown                                                    | has the appropriate options in the dropdown                                                        | PASS                      |
| 65 | product management - add a product  | is course dropdown                                                    | has the appropriate options in the dropdown                                                        | PASS                      |
| 66 | product management - add a product  | select image button                                                   | opens files locally for selection                                                                  | PASS                      |
| 67 | product management - add a product  | cancel button                                                         | brings the user to the all products page                                                           | PASS                      |
| 68 | product management - add a product  | add product button                                                    | submits form                                                                                       | PASS                      |
| 69 | product management - edit a product | select image button                                                   | opens files locally for selection                                                                  | PASS                      |
| 70 | product management - edit a product | cancel button                                                         | brings the user to the all products page                                                           | PASS                      |
| 71 | product management - edit a product | remove button on the image                                            | when update product is clicked this removes the image                                              | PASS                      |
| 72 | product management - edit a product | update product button                                                 | submits the form and edits the information for that item                                           | PASS                      |
| 73 | login                               | forgot password                                                       | brings the user to a password reset page                                                           | PASS                      |
| 74 | login                               | home button                                                           | brings the user to the index page                                                                  | PASS                      |
| 75 | login                               | signin                                                                | submits the form and authenticates the user                                                        | PASS                      |
| 76 | register page                       | back to login button                                                  | brings the user to the login page                                                                  | PASS                      |
| 77 | register page                       | sign up button                                                        | submits the form if valid and send the user to a confirm email page                                | PASS                      |
| 78 | logout page                         | cancel button                                                         | sends the user to the index page                                                                   | PASS                      |
| 79 | logout page                         | sign out button                                                       | sends the user to the index page and shows success toast saying you have signed out                | PASS                      |
...
| 8  | average star rating on wishlist items         | the stars fill to solid correctly depending on what the average rating is                                                                       | PASS                      |
| 9  | display of your own and other peoples reviews | displays reviews on cards with the newest ones at the top                                                                                       | PASS                      |
| 10 | count of reviews on products details page     | the number goes up and down correctly according to how many reviews are on that item                                                            | PASS                      |
| 11 | edit review form button                       | submits the form with the edit, this works as intended                                                                                          | PASS                      |
| 12 | edit review form 'cancel' button              | reverses the user back to the product detail page they were on                                                                                  | PASS                      |
| 13 | review delete form 'confirm' button           | submits the request to delete the review                                                                                                        | PASS                      |
| 14 | review delete form 'cancel' button            | reverses the user back to the product detail page they were on                                                                                  | PASS                      |
...
| --------------------------------------------------- | ----- | -------- | -------------- | ------- | ------- | -------- | ---- | -------- | ---------------- | ------------- | ---------------- | ----------------- | ------------------- | ----------- | ------------- | -------- | ----- | ------ |
| navbar horizontal                                   | PASS  | PASS     | PASS           | PASS    | PASS    | PASS     | PASS | PASS     | PASS             | PASS          | PASS             | PASS              | PASS                | PASS        | PASS          | PASS     | PASS  | PASS   |
| navbar dropdown                                     | PASS  | PASS     | PASS           | PASS    | PASS    | PASS     | PASS | PASS     | PASS             | PASS          | PASS             | PASS              | PASS                | PASS        | PASS          | PASS     | PASS  | PASS   |
| search bar >992px                                   | PASS  | PASS     | PASS           | PASS    | PASS    | PASS     | PASS | PASS     | PASS             | PASS          | PASS             | PASS              | PASS                | PASS        | PASS          | PASS     | PASS  | PASS   |
| search bar <992px                                   | PASS  | PASS     | PASS           | PASS    | PASS    | PASS     | PASS | PASS     | PASS             | PASS          | PASS             | PASS              | PASS                | PASS        | PASS          | PASS     | PASS  | PASS   |
| hero image (man on mountain or people on the phone) | PASS  | na       | na             | PASS    | na      | na       | na   | na       | na               | na            | na               | na                | na                  | na          | na            | PASS     | PASS  | PASS   |
| hero section (grey rectangle)                       | na    | PASS     | na             | na      | na      | na       | na   | na       | na               | na            | na               | na                | PASS                | na          | na            | na       | na    | na     |
| cover text                                          | PASS  | PASS     | na             | na      | na      | na       | na   | na       | na               | na            | na               | na                | PASS                | na          | na            | PASS     | PASS  | PASS   |
| footer                                              | PASS  | PASS     | PASS           | PASS    | PASS    | PASS     | PASS | PASS     | PASS             | PASS          | PASS             | PASS              | PASS                | PASS        | PASS          | PASS     | PASS  | PASS   |
| mailchimp section                                   | PASS  | PASS     | PASS           | PASS    | PASS    | PASS     | PASS | PASS     | PASS             | PASS          | PASS             | PASS              | PASS                | PASS        | PASS          | PASS     | PASS  | PASS   |
| contact form                                        | na    | na       | na             | PASS    | na      | na       | na   | na       | na               | na            | na               | na                | na                  | na          | na            | na       | na    | na     |
| review cards                                        | na    | na       | PASS           | na      | na      | na       | na   | na       | na               | na            | na               | na                | na                  | na          | na            | na       | na    | na     |
| review form                                         | na    | na       | PASS           | na      | na      | na       | na   | na       | na               | na            | na               | na                | na                  | na          | na            | na       | na    | na     |
