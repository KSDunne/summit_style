...
class Product(models.Model):
    ...
    Fields:
        - `category` (ForeignKey): Reference to the category this product
            belongs to (optional).
        - `sku` (CharField): Stock Keeping Unit for the product (optional).
        - `name` (CharField): Name of the product.
        - `description` (TextField): Description of the product.
        - `has_sizes` (BooleanField): Indicates whether the product comes in
            different sizes (optional).
        - `is_course` (BooleanField): Indicates whether the product is a course
            (optional).
        ...
        - `wishlist` (ManyToManyField): Reference to users who have added this
    ...
    Methods:
        ...
        - `number_of_wishes()`: Counts the number of users who have added this
            product to their wishlist.
    ...
    def average_rating(self) -> int:
        avg_rating = (
            Star.objects.filter(product=self).aggregate(Avg("rating"))
            ["rating__avg"] or 0)
...
class Star(models.Model):
    ...
    Fields:
        - `user` (ForeignKey): Reference to the user who submitted the
            rating and review.
        - `product` (ForeignKey): Reference to the product being rated
            and reviewed.
        - `rating` (IntegerField): Numeric rating given by the user, ranging
            from 1 to 5.
        - `title` (CharField): Title of the review.
        - `body` (TextField): Content of the review.
        - `created_on` (DateTimeField): Date and time when the review
            was created.
        - `updated_on` (DateTimeField): Date and time when the review
            was last updated.
    ...
    Credit: https://medium.com/geekculture/django-implementing-star-
                rating-e1deff03bb1c
    """
